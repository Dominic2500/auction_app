                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.exists()) {
                            ...
                            pay_pro_cost.setText("KSH" + Collections.max(products.getpBid().values()));
                            Glide.with(getApplicationContext()).
                                    load(products.getProductListImgURL())
                                    .into(pay_pro_img);
                            pay_ui.setVisibility(View.VISIBLE);
                            pay_amount.setText("PAY KSH" + Collections.max(products.getpBid().values()));
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.exists()) {
                            ...
                            pay_wallet_amount.setText("KSH" + userProfile.getWallet());
