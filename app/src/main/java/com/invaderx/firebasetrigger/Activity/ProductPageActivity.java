...
public class ProductPageActivity extends AppCompatActivity {
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.exists()) {
                            ...
                            pro_currentbid.setText("KSH" + Collections.max(products.getpBid().values()));
                            pro_category.setText("Category: " + products.getpCategory());
                            pro_condition.setText("Condition: " + products.getpCondition());
                            pro_base_price.setText("Base Price: KSH" + products.getBasePrice());
                            ...
                            if (products.getpBid().containsKey(firebaseUser.getUid())) {
                                ...
                                if (products.getpStatus().equals("live")) {
                                    ...
                                    pro_user_bid.setText("Your Bid: KSH" + products.getpBid().get(firebaseUser.getUid()));
                            ...
                            //for admin
                            else if (firebaseUser.getEmail().equals("mayhemdth@gmail.com")) {
    ...
    public void bidPopup() {
        ...
        bid_pro_currentBid.setText("KSH" + Collections.max(products.getpBid().values()));
        //-----------------------------------------------------------------------
